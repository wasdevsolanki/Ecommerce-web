...
Route::post('/get-products', [HomeController::class, 'getProducts'])->name('get-products');
Route::post('/fetch_pet_products', [HomeController::class, 'fetchPetProducts'])->name('fetch.pet.products');
// dzn creates routes
...
Route::group(['middleware' => ['is_user']],function() {
    ...
    Route::group(['prefix' => 'blog'], function () {
        ...
        Route::get('/{slug}', [BlogController::class, 'blogDetailBySlug'])->name('blog.details.slug');
    });
    ...
    Route::group(['prefix' => 'cart'], function () {
        ...
        Route::get('single-product/{id}', [CartController::class, 'singleProductCart'])->name('single.product.cart');
    ...
    Route::group(['prefix' => 'product'], function () {
        ...
        Route::get('categoryby/{category}', [ProductController::class, 'CategoryWiseProductFind'])->name('category.product.find');
        Route::get('brandby/{brand}', [ProductController::class, 'BrandWiseProductFind'])->name('brand.product.find');
        Route::get('category/left/{id}', [ProductController::class, 'CategoryWiseProductLeft'])->name('category.product_left');
        Route::get('categoryby/left/{category}', [ProductController::class, 'CategoryWiseProductLeftFind'])->name('category.product_left.find');
        ...
        Route::get('brandby/left/{brand}', [ProductController::class, 'BrandWiseProductLeftFind'])->name('brand.product_left.find');
    });
    ...
    Route::group(['prefix' => 'design'], function () {
        Route::get('', [DesignController::class, 'index'])->name('design');
        Route::get('product/{slug}', [DesignController::class, 'DesignProduct'])->name('design.product');
        Route::get('delete/{slug}', [DesignController::class, 'DesignDelete'])->name('design.delete');
        Route::get('destroy/{slug}', [DesignController::class, 'destroy'])->name('design.destroy');
        Route::get('buynow/{id}', [DesignController::class, 'BuyNow'])->name('design.buynow');
        Route::post('buynow', [DesignController::class, 'BuyNow'])->name('design.buynow');
    });
