...
// Bind a keyup event to the search input field
        $('#searchwidget').on('keyup', function(event) {
            ...
            searchTimeout = setTimeout(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        // Update the content of the element with the retrieved data
                        $('#filterProduct').html(data);
                    },
                    error: function(data) {
            ...
            }, 500); // 500 milliseconds delay before searching
        });
