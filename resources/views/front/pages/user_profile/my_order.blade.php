...
@section('content')
                                                ...
                                                @forelse ($all_orders as $ao)
                                                    <tr>
                                                        <td>
                                                            ...
                                                            @if(! empty($ao->shipping_method_id) )
                                                                <p>{{ GetShippingMethod($ao->shipping_method_id)->name }}: <a target="_blank" class="text-decoration-underline" href="{{ GetShippingMethod($ao->shipping_method_id)->url }}">{{$ao->shipping_method_tracking_id}}</a> &nbsp; <i class="fas fa-copy" title="Copy" onclick="myFunction()"></i></p>
                                                                <input type="text" value="{{$ao->shipping_method_tracking_id}}" id="myInput" style="display:none">
                                                                <div id="copiedPopup" class="copied-popup">Copied!</div>
                                                            @endif
    ...
    <script>
        ...
        function showCopiedPopup() {
            ...
            // copiedPopup.style.add("show");
            copiedPopup.style.display = "block";

//   // Hide the popup after 2 seconds (adjust time as needed)
            setTimeout(function() {
