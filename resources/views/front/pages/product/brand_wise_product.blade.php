                            ...
                            <div class="col-md-3">
                                <div class="product-section-top-left">
                                    ...
                                    <div class="list-grid-view">
                                        <a href="{{route('brand.product_left.find', $category_m->en_BrandName)}}" class="view-btn list-view"><img class="view-icon" src="{{asset('frontend/assets/images/view-list.svg')}}" alt="view-list" /></a>
                                        <a href="{{route('brand.product.find', $category_m->en_BrandName)}}" class="view-btn grid-view active"><img class="view-icon" src="{{asset('frontend/assets/images/view-grid.svg')}}" alt="view-grid" /></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-9">
                                    ...
                                    <form>
                                        <select class="form-select sortingFilter">
                                            ...
                                            @foreach(Brnad() as $item)
                                                <option value="{{route('brand.product.find', $item->en_BrandName)}}">{{ langConverter($item->en_BrandName, $item->fr_BrandName)  }}</option>
                                            @endforeach
                                        </select>
                                    </form>
                                </div>
