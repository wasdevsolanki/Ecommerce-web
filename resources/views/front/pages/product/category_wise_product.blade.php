                    ...
                    <div class="sidebar-widget-area mobile-sidebar">
                        ...
                        <div class="single-widget categories-widget">
                            ...
                            <div class="categories-list">
                                @foreach(ChildCatList($category_m->en_Category_Name) as $cateogories)
                            ...
                            <div class="col-md-3">
                                <div class="product-section-top-left">
                                    ...
                                    <div class="list-grid-view">
                                        <a href="{{route('category.product_left.find', $category_m->en_Category_Name)}}" class="view-btn list-view"><img class="view-icon" src="{{asset('frontend/assets/images/view-list.svg')}}" alt="view-list" /></a>
                                        <a href="{{route('category.product.find', $category_m->en_Category_Name)}}" class="view-btn grid-view active"><img class="view-icon" src="{{asset('frontend/assets/images/view-grid.svg')}}" alt="view-grid" /></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-9">
                                <div class="product-filter">
                                    <form>
                                        <select class="form-select sortingFilter">
                                            ...
                                            @foreach(ChildCatList($category_m->en_Category_Name) as $item)
                                                <option   value="{{ route('category.product.find', $item->en_Category_Name) }}">{{ langConverter($item->en_Category_Name, $item->fr_Category_Name)  }}</option>
                                            @endforeach
                                        </select>
                                    </form>
                                </div>
                        ...
                        <div class="product-list">
                            <div class="row">
                                @foreach($products as $product)
                                    <div class="col-lg-manual col-md-4 col-sm-6">
...
{{--                    <h3 class="widget-title">{{__('Categories')}}</h3>--}}
{{--                    <div class="categories-list">--}}
{{--                        @foreach(ParentCategory() as $cateogories)--}}
{{--                            <div class="single-categorie">--}}
{{--                                <div class="categorie-left">--}}
