    ...
    <div class="breadcrumb-area">
        <div class="container">
            <div class="breadcrumb-wrap text-center">
                <h2 class="page-title">{{ $products->category->en_Category_Name }}</h2>
                <ul class="breadcrumb-pages">
                    <li class="page-item"><a class="page-item-link" href="{{route('front')}}">{{__('Home')}}</a></li>
                    <li class="page-item">{{ $products->category->en_Category_Name }}</li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <div class="product-single-right">
                            <div class="product-info">
                                ...
                                <div class="product-size-area">
                                    ...
                                    @if($products->category->en_Category_Name == 'Clothing')
                                    <div class="product-size-area">
                                        <h4 class="size-title">Designing Section</h4>
                                        <ul class="size-switch">
                                            <a href="{{route('design.product', $products->en_Product_Slug)}}"><li class="shadow-sm bg-dark text-light single-size activeSize"><i class="icon fas fa-plus-circle"></i>  Customize</li></a>
                                        </ul>
                                    </div>
                                    @endif
                                ...
                                <div class="product-bottom-button d-flex">
                                    <a href="javascript:void(0)" title="{{__('Add To Cart')}}" class="primary-btn addCart" data-id="{{$products->id}}">{{__('Add To Cart')}} <i class="icon fas fa-plus-circle"></i></a>
                                    <a href="javascript:void(0)" class=" add-cart buyNow" data-id="{{$products->id}}">{{__('Buy Now')}}</a>
                                </div>
                            </div>
