                            ...
                            <div class="col-md-3">
                                <div class="product-section-top-left">
                                    ...
                                    <div class="list-grid-view">
                                        <a href="{{route('category.product_left.find', $category_m->en_Category_Name)}}" class="view-btn list-view active"><img class="view-icon" src="{{asset('frontend/assets/images/view-list.svg')}}" alt="view-list" /></a>
                                        <a href="{{route('category.product.find', $category_m->en_Category_Name)}}" class="view-btn grid-view"><img class="view-icon" src="{{asset('frontend/assets/images/view-grid.svg')}}" alt="view-grid" /></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-9">
                                    ...
                                    <form>
                                        <select class="form-select sortingFilter" >
                                            ...
                                            @foreach(ChildCategory() as $item)
                                                <option  value="{{route('category.product_left.find', $item->en_Category_Name)}}">{{ langConverter($item->en_Category_Name, $item->fr_Category_Name)  }}</option>
                                            @endforeach
                                        </select>
                                    </form>
                                </div>
        ...
        <div class="offcanvas-body">
            <div class="sidebar-widget-area">
                ...
                <div class="single-widget categories-widget p-0 bg-transparent">
                    <h3 class="widget-title">{{__('Categories')}}</h3>
                    <div class="categories-list">
                        @foreach(ChildCategory() as $cateogories)
                            <div class="single-categorie">
                                <div class="categorie-left">
