                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="single-contact-info border-0 text-center">
                                    <img class="contact-info-icon" src="{{asset('frontend/assets/images/telephone.png')}}" alt="contact-info" />
                                    <h3 class="contact-info-title">{{__('Phone')}}</h3>
                                    <p class="contact-info-content">Call Us +1 469 287 9823</p>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="single-contact-info text-center">
                                    ...
                                    <p class="contact-info-content">102 E Royall Blvd Malakoff, 75148 Texas, United States</p>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="single-contact-info text-center">
                                    ...
                                    <p class="contact-info-content">We are open for 24/7 </p>
                                </div>
                            </div>
