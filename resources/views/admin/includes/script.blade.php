...
<script src="{{asset('backend/vendor/Trumbowyg/dist/plugins/fontsize/trumbowyg.fontsize.min.js')}}"></script>
<script src="{{asset('backend/vendor/Trumbowyg/dist/plugins/fontfamily/trumbowyg.fontfamily.min.js')}}"></script>
<script src="{{asset('backend/vendor/Trumbowyg/dist/plugins/pasteembed/trumbowyg.pasteembed.min.js')}}"></script>
