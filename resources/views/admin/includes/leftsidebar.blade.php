...
<div class="sidebar__area">
    ...
    <ul id="sidebar-menu" class="sidebar__menu">
        ...
        @canany(['user-list'])
            <li class="{{ isset($menu) && $menu == 'admins' ? 'mm-active' : ''  }}">
                ...
                <ul>
                    ...
                    <li class="{{isset($submenu) && $submenu == 'location' ? 'mm-active' : '' }}">
        ...
        @canany(['user-list'])
            <li class="{{ isset($menu) && $menu == 'activity' ? 'mm-active' : ''  }}">
                <a class="has-arrow" href="#">
                    <i class="fas fa-user"></i>
                    <span>User Activity</span>
                </a>
                <ul>
                    <li class="{{isset($submenu) && $submenu == 'user-activity' ? 'mm-active' : '' }}">
        ...
        @canany(['product-list'])
            <li class="{{ isset($menu) && $menu == 'products' ? 'mm-active' : ''  }}">
                ...
                <ul>
                    ...
                    <li class="{{isset($submenu) && $submenu == 'product-template' ? 'mm-active' : '' }}">
        ...
        <!-- Stock manage dzn by wasdev start -->
        <li class="{{ isset($menu) && $menu == 'stock' ? 'mm-active' : ''  }}">
            <a href="{{ route('admin.stock') }}">
                <i class="fas fa-cube"></i>
                <span>Stock Manage</span>
            </a>
        </li>
        <!-- Stock manage dzn by wasdev end   -->
        ...
        @canany(['delivery-charge-list'])
            ...
            <li class="{{ isset($menu) && $menu == 'shipping_method' ? 'mm-active' : ''  }}">
                <a class="has-arrow" href="#">
                    <i class="fas fa-shipping-fast"></i>
                    <span>Delivery & shipping</span>
                </a>
                <ul>
                    <li class="{{isset($submenu) && $submenu == 'delivery_charge' ? 'mm-active' : '' }}">
                        <a href="{{route('admin.country_dc_list')}}">
                            <i class="fas fa-shipping-fast"></i>
                            <span>{{__('Delivery Charge')}}</span>
                        </a>
                    </li>
                    <li class="{{isset($submenu) && $submenu == 'shipping_method_list' ? 'mm-active' : '' }}">
        ...
        @canany(['delivery-charge-list'])
            <li class="{{ isset($menu) && $menu == 'api_access' ? 'mm-active' : ''  }}">
                <a class="has-arrow" href="#">
                    <i class="fas fa-shipping-fast"></i>
                ...
                <ul>
                    ...
                    <li class="{{isset($submenu) && $submenu == 'create-api' ? 'mm-active' : '' }}">
                        <a href="{{route('admin.apiaccess.create')}}">
                            <i class="fa fa-circle"></i>
                            <span>Assign API</span>
                        </a>
                    </li>

                    <li class="{{isset($submenu) && $submenu == 'api_list' ? 'mm-active' : '' }}">
                        <a href="{{route('admin.apiaccess')}}">
                            <i class="fas fa-shipping-fast"></i>
                            <span>API List</span>
                        </a>
                    </li>
